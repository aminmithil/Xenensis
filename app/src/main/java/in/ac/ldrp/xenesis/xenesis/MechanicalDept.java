...
public class MechanicalDept extends AppCompatActivity {
    String id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechanical_dept);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
      ...
      //  getMenuInflater().inflate(R.menu.menu_mechanical_dept, menu);
        return true;
    }
