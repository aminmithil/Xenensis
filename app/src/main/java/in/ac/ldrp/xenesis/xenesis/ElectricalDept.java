...
public class ElectricalDept extends AppCompatActivity {
    String id;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrical_dept);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
       ...
       // getMenuInflater().inflate(R.menu.menu_electrical_dept, menu);
        return true;
    }
